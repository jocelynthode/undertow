...
package io.undertow.examples.openssl;
 ...
 */
@UndertowExample(value = "OpenSSL", location = "https://localhost:8443")
public class OpenSSLServer {
...
//        reverseProxy.start();
    ...
    private static KeyStore loadKeyStore(String name) throws Exception {
        ...
        if(storeLoc == null) {
            stream = OpenSSLServer.class.getResourceAsStream(name);
        } else {
